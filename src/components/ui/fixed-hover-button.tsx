...
interface FixedHoverButtonProps extends React.ButtonHTMLAttributes<HTMLButtonElement> {
  children: React.ReactNode;
  height?: string;
}

const FixedHoverButton = React.forwardRef<HTMLButtonElement, FixedHoverButtonProps>(
  ({ className, children, height = "48px", ...props }, ref) => {
...
FixedHoverButton.displayName = "FixedHoverButton";

export { FixedHoverButton };
