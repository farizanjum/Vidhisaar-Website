                ...
                <div className="max-w-3xl mx-auto text-center">
                    ...
                    <motion.div custom={1} variants={fadeUpVariants} initial="hidden" animate="visible">
                        <h1 className="text-2xl sm:text-4xl md:text-5xl font-bold mb-6 md:mb-8 tracking-tight">
                            <span className="bg-clip-text text-transparent bg-gradient-to-b from-white to-white/80 text-7xl">
                                {title1}
                            </span>
                            <br />
                    ...
                    <motion.div custom={3} variants={fadeUpVariants} initial="hidden" animate="visible" className="flex flex-col items-center gap-4">
                        <ShinyButton onClick={scrollToWaitlist} className="px-8 py-3 text-white bg-indigo-500/20 hover:bg-indigo-500/30">
                            Join the Waitlist
                        </ShinyButton>
